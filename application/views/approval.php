				...
				<table id="dataTable" class="table table-hover table-sorter" style="width: 100%">
					...
					?>
						<tr>
							...
							<td>
								<a data-toggle="modal" data-target=".bd-example-modal-sm" onclick=""><i class="fa fa-edit"></i></a>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="post" action="<?=base_url(). 'home/update/' .$id  ?>">
